...
# Acknowledgement
　　The FYP project is based on Professor Fuh Ying Hsi FYP project: **Development of an AI-based region detection App. for wound healing therapy.**
　　Thanks, Professor Fuh and Professor Lu, for their great help during the completion of the project. Thanks for the opportunity given by NUS.


# Record For Using Wound Analysis App
　　This passage is written to introduce the function of the FYP application.
...
<video width="400" height="680" controls>
<source src="patient_creation.mp4">
</video>

#### Report Sent via E-mail
<video width="700" height="400" controls>
<source src="email_send.mp4">
</video>

#### Patient History Query
<video width="400" height="680" controls>
<source src="patient_history.mp4">
</video>

### 2.3 Wound Analysis System Based on Deep Learning

<video width="400" height="680" controls>
<source src="wound_segmentation.mp4">
</video>

### 2.4 Other Functions Covered by App

<video width="400" height="680" controls>
<source src="other_functions.mp4">
</video>
...
![UI Interface for Login Page](login.png)
### 3.1 Login Page 
...
- **Add Verification or Error Prompt** - Added prompts for incorrect types, including incorrect password, input user does not exist, etc. Set the login button to Progress Button to optimize the interface design and user experience. The detailed demo is shown below:
![Verification or Error Prompt--Version 0.1.0](login_update.gif)
...
![UI Interface for Login Page--Updated](login_update.png)
...
![Icon Button for Password Retrieve](password_retrieve_icon.png)
...
![Auto Fill the Textfield ](user_list.gif)
...
![Added Remember User Option](remember_checkbox.png)
...
![UI Interface for Register Page](register.png)

### 3.3 Password Retrieve Page 
#### Updated at 2020/02/18
　　This function is designed to account for the possibility of users forgetting their passwords. To retrieve and reset the password, users enter the email used during registration and then log in. The design of its interface is shown in the figure below.
![UI Interface for Retrieve Page](retrieve.png)
...
![UI Interface for Adding Patient Page](add.png)
...
![Double Click To Activate DatePicker](datepicker.gif)
...
![UI Interface for Home Page](home.png)
...
![Navigation Drawer](navigation.png)
...
![Chips on Home Page](home_chips.png)

　　The icon button in the right corner of the home page activates the dialog with the QR code, which you can scan to visit this personal blog.
![QRcode View](qrcode.png)
...
![Application Example of Image Analysis](analyze.gif)
...
![Wound Analysis Report](wound_report.png)
...
![Optimized File Manager](file_manager.png)	
...
![Patient List](patient_history.png)
...
![Patient List & Detailed Patient Information](patient_history_updated.png)
...
![Weather In Singapore](weather.gif)
...
![UI Interface for Personal Setting Page](setting.png)
...
###  10.4 Password Reset 
#### Updated at 2020/02/21
　　This function provides a password reset option for users who have successfully logged in. When the old password is inconsistent with the original password, the new password is stored in the corresponding user information in the database. This function also considers using **FireBase** as storage in subsequent iterations of the database. For specific operations, please follow the pop-up prompts and confirm. 
![Password Reset Dialog](password_reset.png)

###  10.5 Logout Current Account 
　　The logout function will log out of the current login account and jump to the login page. This function provides the application with the ability to independently use multiple accounts and stores user information separately.

## 11. Help Page 
　　The help page contains the chatbot, which has the ability to answer questions for the users. The chatbot can answer questions like:
- **How are you**
- **How to upload**
- **How to use AI**
- **How to add**
...
![Sample Questions for Help Page](chatbot.png)
